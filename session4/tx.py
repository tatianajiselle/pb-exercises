...
class Tx:
    ...
    def sig_hash(self, input_index, hash_type):
        ...
        tx_in.script_pubkey = script_pubkey
        ...
        result = alt_tx.seralize() + int_to_little_endian(hash_type, 4)
...
class TxIn:
    ...
    def serialize(self):
        ...
        prev_sig_script = self.script_sig.serialize()
        # encode_varint on the length of the scriptSig
        result += encode_varint(len(prev_sig_script))
        # add the scriptSig
        result += prev_sig_script
